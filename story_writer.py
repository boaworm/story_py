...
def main():
    ...
    chunk_prompt_template = (
        ...
        "Below is the story background and previous chapter summaries, followed by the key events you must cover.\n"
        "\n"
        "BEGINNING OF BACKGROUND\n{previous_story}\n"
        "END OF BACKGROUND\n\n"
        "BEGINNING OF KEY EVENTS (MUST ALL BE COVERED, IN ORDER, NONE SKIPPED)\n{key_events}\n"
        "END OF KEY EVENTS\n\n"
        "WRITING INSTRUCTIONS — follow these exactly when generating the continuation below:\n"
        "Write ONLY the next section continuing from where the previous text ended. DO NOT repeat or rewrite any part of the previous story.\n"
        "You MUST cover EVERY numbered key event listed above, in order, without skipping any. Each numbered event is mandatory. Do not skip, merge, or omit any event.\n"
        "STOP writing the moment you have covered the last numbered key event. Do NOT write anything after it. Do NOT wrap up, conclude, or add any content beyond the last numbered event.\n"
        "Use simple language, short to medium sentences.\n"
        "Write natural, fluent prose. Never drop articles (a, an, the) or prepositions — every noun phrase must be complete. Write 'into the sun', not 'into sun'; 'by the fire', not 'by fire'.\n"
        ...
        "PRESENT TENSE ONLY. Use 'Vasu strikes' not 'Vasu struck', 'she moves' not 'she moved'. Never slip into past tense.\n"
        ...
        "Do not introduce new characters, locations, or events unless they appear in the key events above.\n"
        "Do not add titles, headers, or numbered sections. Output pure flowing prose only.\n"
        "Open each new section with something unexpected — a sharp action, a sound, a line of dialogue, or a single vivid detail. Avoid formulaic openings like 'Morning light filtered...', 'The fire crackled...', or rolling through each character's state one by one.\n"
        "NEVER reproduce or paraphrase any key event text as a header, label, or sentence opener.\n"
        "Vary your sentence openings. Never start more than two sentences in a row with the same word, especially pronouns like 'He', 'She', or 'They'.\n"
